  ...
  return (
    <article className="post" key={ind}>
      <div className="post__header">
        <div className="post__profile" >
          <a
            ...
            rel="noreferrer"
            onDoubleClick={()=>setLike(1)}
          >
            <img src={item.profile} alt="User Picture" />
          </a>
          <a href="/" target="_blank" className="post__user" rel="noreferrer">
            {item.name}
          </a>
        </div>
      ...
      <div className="post__content">
        <div className="post__medias" onDoubleClick={()=>setLike(like===0?1:0)}>
          <img
            className="post__media"
            src={item.posts.photo}
            alt="Post Content"
          />
        </div>
      </div>
